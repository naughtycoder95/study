...
--  예) 문자열 -> 날짜형변경 함수 : TO_DATE(SYSDATE, 'YYYY/MM/DD')
...
-- 9) DEPT_COPY 테이블에서 부서 번호가(DNO) 10이거나(OR) 40인 부서를 제거하세요.
-- 힌트) IN 예약어 (조건식)
DELETE DEPT_COPY
WHERE DNO IN (10, 40);
-- 확정
